...
&kp GRAVE,         &kp N1,            &kp N2,            &kp N3,            &kp BSLH,          U_NA,              &kp SPACE,         &kp COMMA,         U_MT(RALT, DOT),          U_NA,              \
...
&kp TILDE,         &kp EXCL,          &kp AT,            &kp HASH,          &kp PIPE,          U_NA,              &kp SPACE,         &kp COMMA,         U_MT(RALT, DOT),          U_NA,              \
